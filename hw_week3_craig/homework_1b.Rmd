...
# it looks like floor() rounds down to the nearest integar
# while ceiling() rounds up to the nearest integar
...
```{r}
olyp2 <- seq (1896, 2400, by = 4)
length (olyp2)
# 127 total olypic games
```
